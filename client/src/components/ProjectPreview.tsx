...
const ProjectPreview = forwardRef<ProjectPreviewRef,ProjectPreviewProps>(({project,isGenerating,device: device="desktop",showEditorPanel=true},ref) => {
    ...
    useImperativeHandle(ref,()=>({
        getCode:()=>{
            ...
            // 1. Remove our selection class/ attributes/ outline from all elements.(when we click on elements to update it,it shows a outline. So we need to remove it.)
